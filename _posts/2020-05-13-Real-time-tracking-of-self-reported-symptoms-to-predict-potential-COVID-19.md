...
### Discussion
The small proportion of the overall particpants who have had a test are not a random selection, but are likely to be more unwell individuals.  As such, the prevalence of infection in the untested population (even those with symptoms) is likely to be a lot lower.
Whilst the app has gathered data from a lot of participants, only a small proportion of them have been tested.  The relatively low number of
